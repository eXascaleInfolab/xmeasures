...
inline void xcontrib(AccId& eh, const RawIds& icount, const RawIds& jcount) noexcept
{
...
template <>
inline void xcontrib<false>(AccId& eh, const RawIds& icount, const RawIds& jcount) noexcept
{}
